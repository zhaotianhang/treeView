...
namespace Dashboard1
{
    public class DialogsViewModel : INotifyPropertyChanged
    {
        ...
        private async void ExecuteRunDialog(object o)
        {
            ...
            var view = new 目标管理Dialog
            {
                DataContext = new 目标管理DialogViewModel()
            };
        ...
        private void ExtendedClosingEventHandler(object sender, DialogClosingEventArgs eventArgs)
        {
            ...
            eventArgs.Session.UpdateContent(new 目标管理DialogViewModel());
        ...
        private void AcceptSample4Dialog(object obj)
        {
            ...
            Sample4Content = new 目标管理DialogViewModel();
            Task.Delay(TimeSpan.FromSeconds(3))
